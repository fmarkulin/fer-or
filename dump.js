...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var booksRef, booksSnapshot, books_1, authorsRef, authorsSnapshot, authors_1, dump, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                books_1 = [];
                booksSnapshot.forEach(function (snapshot) { return books_1.push(snapshot.data()); });
                authorsRef = (0, firestore_1.collection)(db, "authors");
                return [4 /*yield*/, (0, firestore_1.getDocs)(authorsRef)];
            case 3:
                authorsSnapshot = _a.sent();
                authors_1 = [];
                authorsSnapshot.forEach(function (snapshot) {
                    return authors_1.push(snapshot.data());
                });
            ...
            case 4:
                e_1 = _a.sent();
                console.log("error dumping data", e_1);
                return [3 /*break*/, 6];
            case 5:
                console.log("exiting...");
